...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (go-mode yaml-mode web-mode sml-mode scss-mode scala-mode sass-mode org markdown-mode jsx-mode flycheck exec-path-from-shell clojure-cheatsheet 4clojure))))
